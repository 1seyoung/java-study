package Algo.basic.delta;

import java.util.Arrays;

// 특정 위치에서 4방 탐색을 진행하는 경우 if-else, if -else --- 코드의 길이가 길어지고 가독성이 떨어지고 나누어  생각하고
// 실수하기 쉽다
public class DeltaTest1 {
    ...
    //delta 는 이동방향에 대해서 Y의 변화량 x의 변화량을 저장하고 이를 활용해서 이동(상하좌우) 좌표를 구하는 방식
    //                  상 하 좌 우
    ...
    static void print4x(int y, int x) {
        for (int d = 0; d < 4; d++) {
            ...
            // 문제 : 대각선 , 8방, 장기의 말 이동 ... 문제가 제시한 이동방향,규칙에 대해서 dy, dx 변화량과 순서를 고려해서 처
